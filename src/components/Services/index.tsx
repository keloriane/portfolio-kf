  ...
  useEffect(() => {
    ...
    const timelines = services.map((service, index) => {
      ...
      timeline
        ...
        .fromTo(descriptionRefs[index].current, { duration: 0.2, opacity: 0, y: 200 }, { opacity: 1, y: 0 }, 0.2)
        .fromTo(techs[index].current, { duration: 0.2, opacity: 0, y: 300 }, { opacity: 1, y: 0, }, 0.3)
