                ...
                <Container className="mt-[75px]">
                    ...
                    >
                        <form className="flex flex-col gap-50px" onSubmit={handleSubmit}>
                            ...
                            <button className="font-medium text-button.default text-fg-default m-3 uppercase" >
                                <span className="group py-5 px-6 relative w-full inline-block overflow-hidden border border-brand-primary rounded-full transition-all duration-700 safari-fix-transform can-hover:hover:border-transparent">
                                    <span role="presentation" className="absolute w-[200%] pb-[200%] rounded-full transition-transform duration-500 scale-0 -translate-x-1/2 -translate-y-1/2 can-hover:group-hover:scale-100 bg-brand-primary" ></span>
                                        <span className="flex relative justify-center items-center transition-all can-hover:group-hover:text-fg-inverted"><span className="col-start-1 row-start-1">
                                            Meet the team
                                        </span>
                                    </span>
                                </span>
                            </button>
                            <button type="submit" className="rounded-full bg-white text-[#212121] text-sm mt-[25px] p-5 max-w-[150px] font-bold">Send</button>
                        </form>
