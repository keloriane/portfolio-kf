...
const Contact = ({className}:{className:string}) => {
    ...
    return ( 
        <section className={twMerge("h-screen w-full" , className)}>
            <Container>
                <Col colStart={1} colEnd={14}>
            <div className="font-bold  text-black">
                <AnimatedText text="Do you have an idea ?" splitBy="word" gap="5px" duration={1} as="h2" className="text-[65px]" />
                <AnimatedText text="Want to bring it to life ?" splitBy="word" gap="5px" duration={1} as="h2" className="text-[65px] "/>
            </div>
                    <p
            ...
            <Container className="mt-[175px]">
                <Col
                    colStart={1} colEnd={14} className="flex items-center"
                >
                ...
                <Col colStart={17} colEnd={27} className="flex flex-col items-center ">
