              ...
              <ul>
                {projects.map((project, index) => (
                  <li
                    key={index}
                    className={twMerge(
                      'sm:text-[20px] md:text-[40px] lg:text-[50px] xl:text-[60px] gap-[25px] w-full flex items-center project-item',
